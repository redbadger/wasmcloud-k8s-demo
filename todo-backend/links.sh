...
# wash ctl link $ACTOR_KEY $PROVIDER_KEY_VALUE wasmcloud:keyvalue URL=redis://rfs-redisfailover:26379/
wash ctl link $ACTOR_KEY $PROVIDER_KEY_VALUE wasmcloud:keyvalue URL=fake://rfs-redisfailover:26379/
